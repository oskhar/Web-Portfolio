...
$str = file_get_contents('http://127.0.0.1/myApp/Web-Portfolio-V1/config/con.json');
...
$query = "INSERT INTO viewers VALUES ('$ip')";
mysqli_query($conn,$query);
$vlu += 1;

$result2 = mysqli_query($conn, "SELECT * FROM dataKomentar");
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<body>
    ...
    "><img src="lib/img/komen.webp" alt="iniGambar" width="60" height="60">
    </button>
    <div id="isiKomen">
...
<div id="tombol">
    ...
    <div id="tombol6">
        <div id="hilang6"><h2>Program Animasi</h2><p> Ingin mencari tau sampai sejauh mana manusia bisa mewujudkan imajinasinya dalam bentuk karya visual.</p><p>Data akumulasi views diambil dari API YOUTUBE.</p><img src="lib/img/project5.webp" alt="iniGambar"><a href="http://moskhar.my.id/projectAnimation/"><button id="btnTombol1">BUKA</button></a></div><h3><img src="lib/img/kalender.webp" alt="iniGambar"> Juni 2022</h3>
    </div>
...
<div id="penutup"><div id="viewers" style="position: absolute; top: 150px;left: 0;right: 0;margin: auto;background: transparent;border-bottom: 5px solid #0090e7;border-radius: 5px;height: 210px;width: 50%;"><img src="lib/img/viewers.webp" alt="iniGambar" style="height:120px;width: 120px;position: absolute;left: 0;right: 0;margin: auto;"> <p id="textv" style="font-size: 24px;position: absolute; top: 120px;text-shadow: 3px 3px #0090e7,4px 6px 6px rgb(0,0,0,0.6);font-family: Kanit;left:0;right:0;margin:auto;">views: <?php echo $vlu; ?></p></div><h2 id="logo">O<font style="left: -18px;top: 16px;position: relative;display: inline-block;">S</font></h2><p style="margin-top: 60px;color: white;">Maaf jika ada kata kata yang kurang berkenang, semoga web ini dapat bermanfaat</p>
<p style="font-weight: normal;"><font style="display: inline;font-family:'Baloo Bhaijaan 2';font-weight: bold;"><img src="lib/img/location.webp" alt="iniGambar" id="l"> Lokasi:</font> Jakarta</p>
<p style="margin-top: -10px;font-weight: normal;"><font style="display: inline;font-family:'Baloo Bhaijaan 2';font-weight: bold;"><img src="lib/img/email.webp" alt="iniGambar" id="e"> Email:</font><font style="color: #0090e7;"> muhamadoskhar@gmail.com</font></p>
